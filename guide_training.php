...
<head>
  ...
  <title>Available Training</title>
          ...
          <ul class="menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="guide_announcement.html" target="_blank" rel="noopener"><i class="fas fa-chevron-right"></i> Announcements</a></li>
                  <li><a href="guide_training.php" target="_blank" rel="noopener"><i class="fas fa-chevron-right"></i> Available Training</a></li>
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li class="sidebar-item active">
            <a href="userHomepage.html"><i class="fas fa-home"></i> <span>Home</span></a>
        </li>
        <li class="sidebar-item dropdown">
            <a href="#"><i class="fas fa-globe"></i> <span>Online Services</span> <i class="fas fa-chevron-down dropdown-icon"></i></a>
            <ul class="dropdown-menu">
                <li><a href="guide_announcement.html" target="_blank" rel="noopener"><i class="fas fa-chevron-right"></i> E-Office</a></li>
                <li><a href="guide_training.php" target="_blank" rel="noopener"><i class="fas fa-chevron-right"></i> E-Licensing</a></li>
                <li><a href="guide_certifications.html"><i class="fas fa-chevron-right"></i> E-booking</a></li>
            </ul>
        </li>
    </ul>
