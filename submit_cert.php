...
$username = "root"; 
$password = ""; 
$dbname = "e_office";  // Change this to your actual database name
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO guide_certifications (full_name, username, email, certifications, cert_expiry, cert_files) 
            VALUES (?, ?, ?, ?, ?, ?)";
    
    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param("ssssss", $full_name, $guide_username, $email, $certifications, $cert_expiry, $cert_files);
        ...
        if ($stmt->execute()) {
            ...
            echo '<script type="text/javascript">
                    ...
                    window.location.href = "adminHomepage.php";  // Redirect to admin homepage
                  </script>';
